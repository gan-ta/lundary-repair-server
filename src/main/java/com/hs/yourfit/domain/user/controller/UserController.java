...
import com.hs.yourfit.domain.user.dto.response.UserCreateResponse;
import com.hs.yourfit.domain.user.service.*;
...
public class UserController {
    ...
    public ResponseData getCustomerUser(@RequestHeader("accessToken") String accessToken){
    ...
    @GetMapping("/seller")
    @ResponseStatus(HttpStatus.OK)
    public ResponseData getSellerUser(@RequestHeader("accessToken") String accessToken){
